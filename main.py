...
modelParams = ModelParams(in_dim=300, max_epochs=300000, batch_size=15000, learning_rate=0.01, class_threshold=0.5, dropout=0., nn_params = [300, 3000, 3000, 2000, 1000, 1000])
# # embedding = "word2vec"
# embedding = "fasttext"
# # embedding = "glove"
