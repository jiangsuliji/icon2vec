...
modelParams = ModelParams(in_dim=300, max_epochs=300000, batch_size=65000, learning_rate=0.0001, class_threshold=0.5, dropout=0., nn_params = [300, 1000, 1000, 1000, 900])
# # embedding = "word2vec"
# embedding = "fasttext"
# # embedding = "glove"
